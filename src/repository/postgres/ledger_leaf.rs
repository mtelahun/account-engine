...
use crate::{
    domain::AccountId,
    repository::{
        postgres::repository::PostgresRepository, OrmError, Resource, ResourceOperations,
    },
    resource::ledger,
};

#[async_trait]
impl ResourceOperations<ledger::leaf::Model, ledger::leaf::ActiveModel, AccountId>
