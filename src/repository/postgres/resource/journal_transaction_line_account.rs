...
use crate::{
    ...
    entity::journal_transaction_line_account,
...
impl
    ResourceOperations<
        journal_transaction_line_account::Model,
        journal_transaction_line_account::ActiveModel,
    ...
    > for PostgresRepository
{
    ...
    async fn save(
        &self,
        _model: &journal_transaction_line_account::ActiveModel,
    ) -> Result<u64, OrmError> {
        todo!()
    }
